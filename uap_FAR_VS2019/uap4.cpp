...
//#define VERSION   "20220302  V6.30 vs2019 "

//20220303 V6.31 ching2  D:\ --> E:\    
//20220302 V6.30 ching2  D:\ --> E:\    檔名加年月日
//20220301 V6.20 ching2  myExp->var[17] --> hotpxy ,  128--> 40  bug   
//20220218 V6.10 ching2  E:\ --> D:\ 
//20220210 V6.00 ching2  modify uap for VS2019  及弱掃
...
//
//煩請於錄音系統交易功能流程中新增一功能，
////在「交易錄音請按2.」選2.後 //新 增   時 間 判斷，若入線時間於15:30-24:00(依該台錄音主機時間即可)，
...
//                              apstart也修改過
//   
//   ver 1.4  1000329   sven    0328已先上一版,此版為d:\\改為 e:\\
//
	...
	L8765           E302                ;
		*/
		...
		if (strcmp(sIn_error, sFile_error) == 0)
		{
			...
			//20220218 old strncpy_s(sOut_mess, 4, &str_in[1], 4);   sOut_mess[4] = 0;   // 取1-4 mess code
			strncpy_s(sOut_mess, 5, &str_in[1], 4);   sOut_mess[4] = 0;   // 取1-4 mess code
...
int FAR01b3()
{
	...
	if (strncmp(myExp->var[23], "rec", 3) == 0)
	{
	  ...
	  //   ver 3.2  1050412  ching2  加錄音控制旗標  //myExp->var[23]=rec, myExp->var[24]=close1 close2 副總提到NO ADD NOIVR 修改錄音-1 SESSION 佔滿問題
		...
		//20220218 OLD sprintf_s(myExp->var[17], "T/C=%03d%s No Add NOIVR NoRecord=e:\\rec\\%s", vxp->voie, sv17_hhmmss, myExp->var[18]);     //add 	sv17_hhmmss
			//20220302 V6.30 ching2  D:\ --> E:\ 
			//20220302 old sprintf_s(myExp->var[17], "T/C=%03d%s No Add NOIVR NoRecord=D:\\rec\\%s", vxp->voie, sv17_hhmmss, myExp->var[18]);     //add 	sv17_hhmmss
...
int FAR01f()
{
  ...
  //sprintf_s(newname, "d:\\rec\\%s\\%02d%02d_%02d%02d_%s_%s.wav", myExp->var[1], newtm->tm_mon+1, newtm->tm_mday, newtm->tm_hour, newtm->tm_min,  myExp->var[1], myExp->var[3]);   
	...
	//20220218 OLD sprintf_s(newname, "e:\\rec\\%s\\%02d%02d_%02d%02d_%s_%s.wav", myExp->var[1], newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	//20220302 V6.30 ching2  D:\ --> E:\ 
	//20220302 old sprintf_s(newname, "D:\\rec\\%s\\%02d%02d_%02d%02d_%s_%s.wav", myExp->var[1], newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	sprintf_s(newname, "E:\\rec\\%s\\%03d%02d%02d_%02d%02d_%02d%02d_%s_%s.wav", myExp->var[1],
		newTime.tm_year - 11, newTime.tm_mon + 1, newTime.tm_mday,
		newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	...
	//20220218 OLD sprintf_s(sTemp, "mkdir e:\\rec\\%s\\", myExp->var[1]);
	//20220302 V6.30 ching2  D:\ --> E:\ 
	//20220302 old sprintf_s(sTemp, "mkdir D:\\rec\\%s\\", myExp->var[1]);
	...
	//20220302 old  sprintf_s(num.v25[cnt0].file_name, "/rec/%s/%02d%02d_%02d%02d_%s_%s.wav", myExp->var[1], newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	
	sprintf_s(num.v25[cnt0].file_name, "/rec/%s/%03d%02d%02d_%02d%02d_%02d%02d_%s_%s.wav", myExp->var[1], 
		newTime.tm_year - 11, newTime.tm_mon + 1, newTime.tm_mday,
		newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	...
	//20220218 OLD sprintf_s(newname_mp3, "e:\\rec\\%s\\%02d%02d_%02d%02d_%s_%s.mp3", myExp->var[1], newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	//20220302 V6.30 ching2  D:\ --> E:\ 
	//20220302 old sprintf_s(newname_mp3, "D:\\rec\\%s\\%02d%02d_%02d%02d_%s_%s.mp3", myExp->var[1], newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	sprintf_s(newname_mp3, "E:\\rec\\%s\\%03d%02d%02d_%02d%02d_%02d%02d_%s_%s.mp3", myExp->var[1], 
		newTime.tm_year - 11, newTime.tm_mon + 1, newTime.tm_mday,
		newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	...
	//log
	//20220302 V6.30 ching2  D:\ --> E:\    檔名加年月日
	//20220302 old sprintf_s(num.v25[cnt0].file_name, "/rec/%s/%02d%02d_%02d%02d_%s_%s.mp3", myExp->var[1], newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	sprintf_s(num.v25[cnt0].file_name, "/rec/%s/%03d%02d%02d_%02d%02d_%02d%02d_%s_%s.mp3", myExp->var[1], 
		newTime.tm_year - 11, newTime.tm_mon + 1, newTime.tm_mday, 
		newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	...
	//20220302 V6.30 ching2  D:\ --> E:\    檔名加年月日
	//20220302 old  sprintf_s(smessageFile1_far, "/rec/%s/%02d%02d_%02d%02d_%s_%s.mp3", myExp->var[1], newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	sprintf_s(smessageFile1_far, "/rec/%s/%03d%02d%02d_%02d%02d_%02d%02d_%s_%s.mp3", myExp->var[1], 
		newTime.tm_year - 11, newTime.tm_mon + 1, newTime.tm_mday,
		newTime.tm_mon + 1, newTime.tm_mday, newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
...
//	tm->tm_hour, tm->tm_min, myExp->var[1], myExp->var[3]);
	...
	//20220301 V6.20 ching2  myExp->var[17] --> hotpxy ,  128--> 40  bug   
	//20220301  new
	sprintf_s(myExp->var[13], "%03d%02d%02d", newTime.tm_year - 11, newTime.tm_mon + 1, newTime.tm_mday);
	sprintf_s(myExp->var[18], "%s\\%02d%02d_%s_%s.wav", myExp->var[1], 
		newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
	...
	//20220218 OLD sprintf_s(myExp->var[17], "T/C=%03d%s Caller Add IVR Record=e:\\rec\\%s", vxp->voie, sv17_hhmmss, myExp->var[18]);
	//20220302 V6.30 ching2  D:\ --> E:\
	//sprintf_s(myExp->var[17], "T/C=%03d%s Caller Add IVR Record=D:\\rec\\%s", vxp->voie, sv17_hhmmss, myExp->var[18]);
	...
	//	tm->tm_hour, tm->tm_min, myExp->var[1], myExp->var[3]);
		...
		//1090423 new 
	//20220218 OLD sprintf_s(myExp->var[19], "e:\\rec\\%s\\%03d%02d%02d_%02d%02d_%s_%s.mp3", myExp->var[1], newTime.tm_year - 11, newTime. tm_mon + 1, newTime.tm_mday,
	
	//20220301 V6.20 ching2  myExp->var[17] --> hotpxy ,  128--> 40  bug  
	//20220301 old 
	//sprintf_s(myExp->var[19], "D:\\rec\\%s\\%03d%02d%02d_%02d%02d_%s_%s.mp3", myExp->var[1], newTime.tm_year - 11, newTime. tm_mon + 1, newTime.tm_mday,
	//         newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]); 
	
	//20220303 new  D:\\rec\\%s\\%s_%02d%02d_%s_%s.mp3 改成E:\\
	//20220301 new   myExp->var[13] = yyyymmdd
	//sprintf_s(myExp->var[19], "D:\\rec\\%s\\%s_%02d%02d_%s_%s.mp3", myExp->var[1], myExp->var[13],
	sprintf_s(myExp->var[19], "E:\\rec\\%s\\%s_%02d%02d_%s_%s.mp3", myExp->var[1], myExp->var[13],
			newTime.tm_hour, newTime.tm_min, myExp->var[1], myExp->var[3]);
...
int FAR01r1()
{
  ...
  //strcpy_s( myExp->var[24], "close1" );
	...
	//20220218 OLD sprintf_s(myExp->var[10], "e:\\rec\\%s", myExp->var[18]);
	//20220302 V6.30 ching2  D:\ --> E:\
	//20220302 old sprintf_s(myExp->var[10], "D:\\rec\\%s", myExp->var[18]);
...
int FAR01s()
{
  ...
  //sprintf_s(newname_mp3, "e:\\rec\\%s\\%02d%02d_%02d%02d_%s_%s.mp3", myExp->var[1], newtm->tm_mon+1, newtm->tm_mday, newtm->tm_hour, newtm->tm_min,  myExp->var[1], myExp->var[3]);   
	...
	//20220218 OLD sprintf_s(newname, "e:\\rec\\%s", myExp->var[18]);
	//20220302 V6.30 ching2  D:\ --> E:\
	//20220302 old sprintf_s(newname, "D:\\rec\\%s", myExp->var[18]);
